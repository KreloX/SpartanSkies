...
val blueSkiesVersion: String by project
val structureGelVersion: String by project
...
dependencies {
    ...
    implementation(fg.deobf("maven.modrinth:blue-skies:$blueSkiesVersion"))
    runtimeOnly(fg.deobf("maven.modrinth:structure-gel-api:$structureGelVersion"))
...
tasks.named<ProcessResources>("processResources").configure {
    val replaceProperties = mapOf(
        ...
        "blueSkiesVersion" to blueSkiesVersion
    )
